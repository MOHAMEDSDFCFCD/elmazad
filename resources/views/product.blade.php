...
<head>
    ...
    <link href="{{url('css/products/assets/css/product.css')}}" rel="stylesheet">
    <link rel="stylesheet" href="{{url('css/homepage/bootstrap.min.css')}}">
...
<body>
    ...
    <header id="header" class="header d-flex align-items-center fixed-top" style="margin-bottom:80px; ">
        <div class="container-fluid d-flex align-items-center justify-content-between">
            ...
            {{-- <a href="#" class="logo d-flex align-items-center  me-auto me-lg-0">
                <img src="assets/img/logo.jpg" alt="" style="height:90px ;">
            </a> --}}
            <div class="logoimg">
            ...
            <div class="row" style="width:100% ;">
                <div class="col-xl-7 col-md-8 col-sm-12">
                    ...
                    <div class="portfolio-description" style="text-align: right">
                        <p style="width: auto; height: auto;">({{$search->description}})</p>
                    </div>
                </div>
                        ...
                        <div class="portfolio-info" style="justify-content: right;text-align:right;">
                            ...
                            <ul>
                                ...
                                <li style="text-align: right;"><strong style="font-size:25px ;">مزايدتى</strong> <span>
                                        ...
                                        <button type="submit" value="{{$search->my_bidding}}">مزايدة</button>
    ...
    <script src="{{url('js/products/jquery.js')}}"></script>
