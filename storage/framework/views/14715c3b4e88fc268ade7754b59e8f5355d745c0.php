...
<head>
    ...
    <!-- Favicons -->
    <link href="<?php echo e(url('css/copypage/assets/img/favicon.png')); ?>" rel="icon">
    <link href="<?php echo e(url('css/copypage/assets/img/apple-touch-icon.png')); ?>" rel="apple-touch-icon">
    ...
    <header id="header" class="header d-flex align-items-center fixed-top">
        <div class="container-fluid d-flex align-items-center justify-content-between">
            ...
            <a href="#" class="logo d-flex align-items-center  me-auto me-lg-0 fs-4">
                <img src="<?php echo e(url('/images/products/logo.jpeg')); ?>" alt="" style="width:100px ;height:400px ;">
            </a>
            ...
            <div class="header-social-links">
                ...
                <a href="<?php echo e(route('edit.user')); ?>" class="twitter"><i class="bi bi-twitter"></i></a>
                <a href="<?php echo e(route('favorite.page')); ?>" class="facebook"><i class="bi bi-facebook"></i></a>
                <a href="<?php echo e(route('home.page')); ?>" class="instagram"><i class="bi bi-instagram"></i></a>
                  ...
                  <?php $__currentLoopData = $products; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                     ...
                     <div class="col-md-8 col-lg-6 col-xl-4 ">
                        <div class="card text-white bg-black">
                            <img src="<?php echo e(url('/images/products/'.$product -> photo_product)); ?>" style="height:300px;" />
                            <div class="card-body">
                                <div class="text-center">
                                    <h5 class="card-title"><?php echo e($product -> category_product); ?></h5>
                                    <p class="text-muted mb-4">(<?php echo e($product -> description); ?>)</p>
                                </div>
                                <div>
                                    <div class="d-flex justify-content-between">
                                        <span>ج.م<?php echo e($product -> start_price); ?></span> <span>يبدأ من</span>
                                    </div>
...
</html><?php /**PATH C:\xampp\htdocs\mazada\resources\views/favoritepage.blade.php ENDPATH**/ ?>