...
<head>
    ...
    <link href="<?php echo e(url('css/copypage/assets/css/main.css')); ?>" rel="stylesheet">
    <link href="<?php echo e(url('css/homepage/Home.css')); ?>" rel="stylesheet">
    <link href="<?php echo e(url('css/homepage/bootstrap.min.css')); ?>" rel="stylesheet">
...
<body>
    ...
    <header id="header" class="header d-flex align-items-center fixed-top">
        <div class="container-fluid d-flex align-items-center justify-content-between">
            ...
            <div class="logoimg">
                ...
                <img src="<?php echo e(url('/images/products/logo.jpg')); ?>" alt=""></a>
            </div>
            ...
            <nav id="navbar" class="navbar" style="">
                <ul>
                    ...
                    <li><a href="<?php echo e(route('category.page',$category-> id)); ?>"><?php echo e($category -> name); ?></a></li>
                   <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    <li><a href="<?php echo e(route('view.login.user')); ?>">تسجيل دخول</a></li>
    ...
    <div class="icon2" style="margin-top:200px ; color: white;">
      ...
      <div>
        ...
        <div class="alert alert-danger" id="sessionErr" style="text-align:center;width:auto;height:50px ; margin-top:20px ;margin-left:20px;  " role="alert"><?php echo e(Session::get('error')); ?></div> 
        <?php endif; ?>   
     </div>
     
     <div>
        <?php if(Session::has('success')): ?>
        <center> <div class="alert alert-success" id="sessionErr" style="text-align:center;width:auto;height:50px ; margin-top:20px ;margin-left:-400px;  " role="alert"><?php echo e(Session::get('success')); ?></div>  </center>
        <?php endif; ?>   
     </div>
                ...
                <div class="row justify-content-center" >
                    ...
                    <div class="col-md-8 col-lg-6 col-xl-4 " style="border: solid 1px white;" >
                        <div class="card text-white bg-black ">
                            <a href="<?php echo e(url('product/'.$product-> id)); ?>" class="imglink" style="" ><img src="<?php echo e(url('/images/products/'.$product -> photo_product)); ?>" style="height:300px;width:100% ;margin: auto;background-color: white !important;" /></a>
                            ...
                            <div class="card-body">
                                <div class="text-center">
                                    <a href="<?php echo e(route('category.page',$product-> category_id)); ?>">
                                    <h5 class="card-title" style="text-decoration: none;background-color:gray; padding:2px 20px;font-size:25px ;border-radius:30px ;color: white;text-align: center;width:120px;margin: auto;"><?php echo e($product -> category_product); ?></h5></a>
                                    

                                    
                                    <div class="post">
                                        <p class="content">(<?php echo e($product -> description); ?>)</p>
                                        <button onclick="readMore(this)">اقرأ المزيد</button>
                                    </div>
                                </div>
                                <div>
                                    <div class="d-flex justify-content-between" style="margin-top:20px ">
                                        <span style="text-decoration: none;background-color:gray; padding:2px 20px;font-size:20px ;border-radius:30px ;color: white;text-align: center;width:auto;">ج.م<?php echo e($product -> start_price); ?></span> <span>يبدأ من</span>
                                    </div>
                                    <div class="d-flex justify-content-between mt-2" style="align-items: center">
                                        <span>
                                            <div class="course-countdown" style="margin-left:-14px;">
                                                <ul data-countdown="<?php echo e($product-> expiry_date); ?>" style="margin-bottom:-50px;  ">
    ...
    <script src="<?php echo e(url('js/homepage/jquery.js')); ?>"></script>
    <script>
...
<?php /**PATH C:\xampp\htdocs\mazada\resources\views/homepage.blade.php ENDPATH**/ ?>